...
export const Span_TextBox = styled.span<{ accessibility?: string }>`
  ...
  border: ${styles.borderProperty.primary} ${colors.blue200};
  &.good {
  ...
  &.average {
    ...
    border: ${styles.borderProperty.primary} ${colors.orange200};
  }
  &.bad {
    background-color: ${colors.pink100};
    color: ${colors.red200};
    border: ${styles.borderProperty.primary} ${colors.red200};
  }
`
