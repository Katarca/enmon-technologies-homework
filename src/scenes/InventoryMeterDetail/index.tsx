...
export const InventoryMeterComponent = () => {
  ...
  if (inventoryMeterContext.state.data) {
    return (
      <Div_Wrapper>
        ...
        <Div_SubContainer>
          ...
          <Div_Box>
            ...
            <Div_PaddingContainer>
              <H1_Heading className='fontSizeL'>{inventoryMeterContext.state.data?.id}</H1_Heading>
            </Div_PaddingContainer>
        ...
        <Div_SubContainer className='fullWidth'>
          ...
          <Div_InputsContainer>
            ...
            />
            <Div_ButtonContainer>
              <CustomButton className='green' onClick={() => inventoryMeterContext.handleUpdate()}>
  ...
  } else if (inventoryMeterContext.state.fetchingError) {
    return <Message message={inventoryMeterContext.state.fetchingError} />
  } else if (
    ...
    return <Message message='Inventory meter was not found' />
  }
}
